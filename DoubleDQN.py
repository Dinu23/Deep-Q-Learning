...
class DoubleDQNAgent:
    def __init__(self, env, model_builder = N_Network()):
        self.env = env
            ...
            while True:
                ...
                if step % freq_update_network_from_experience == 0:
                    ...
                    if len(current_states) > 0:
                        ...
                        self.model.train_on_batch(current_states,target)
...
def experiment(no_of_episodes):
    # no_of_episodes = 10
    model_builder = N_Network([512,256,256])
    env = gym.make("CartPole-v1")

    agent = DoubleDQNAgent(env,model_builder)
